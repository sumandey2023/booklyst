    ...
    <MotionFade>
      ...
      >
        <div className="flex items-center justify-center w-16 h-16 rounded-full bg-blue-200 dark:bg-slate-800 mb-4 shadow group-hover:scale-110 transition-transform">
          <ShoppingBagIcon className="w-8 h-8 text-blue-700 dark:text-indigo-300" />
        </div>
        <h2 className="text-2xl font-bold text-blue-800 dark:text-indigo-200 mb-2">E-commerce</h2>
